...
module.exports = {
  ...
  art: process.env.AUTO_RESTART || 'fale',
  sudo: process.env.SUDO || '94722807735',
  ...
  ownername:process.env.OWNER_NAME || 'DARK SASIYA',
  sessionName: process.env.SESSION_ID || 'Ivs1mKRI#OO2qf3wQTlSTrSutBVpNVKcWnsfP6eR6f-NGMd8pLeA',
  author: process.env.PACK_INFO.split(";")[0] || 'author', 
  auto_read_status : process.env.AUTO_READ_STATUS || 'true',
  packname: process.env.PACK_INFO.split(";")[1] || 'Sasiya',
